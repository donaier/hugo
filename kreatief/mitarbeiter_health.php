  ...
  <body>
    <div class="container">
      ...
      <?php
        ...
        $uploaddir = './mitarbeiter_files/' . $ma['vorname'] . $ma['name'] . '/';
        ...
        if (isset($_POST['allergie'])) {
          $post_query = "UPDATE clients SET allergie = '" . $_POST['allergie'] . "' WHERE `clients`.`id` = " . $ma['id'] . "";
        ...
        if (isset($_POST['diagnose'])) {
          $post_query = "UPDATE clients SET diagnose = '" . $_POST['diagnose'] . "' WHERE `clients`.`id` = " . $ma['id'] . "";
      ...
      <div class="row">
        <p class="col-sm-3">Tel:</p>
        <p class="col-sm-9">
          <?php echo $ma['dent_tel'] ?>
        </p>
      </div>
      <div class="row">
        <p class="col-sm-3">Fax:</p>
        <p class="col-sm-9">
          <?php echo $ma['dent_fax'] ?>
        </p>
      </div>
      <div class="row">
        <p class="col-sm-3">Mail:</p>
        <p class="col-sm-9">
          <?php echo $ma['dent_email'] ?>
        </p>
      </div>
      <div class="row">
        <p class="col-sm-3">Adresse:</p>
        <p class="col-sm-9">
          <?php echo nl2br($ma['dent_adresse']) ?>
        </p>
      </div>
      <div class="row">
        <p class="col-sm-3">Kommentar/Termine:</p>
        <p class="col-sm-9">
